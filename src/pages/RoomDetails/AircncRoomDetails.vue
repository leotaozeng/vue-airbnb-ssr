...
<template>
  <div v-if="roomsStore.roomDetails">
    <el-carousel type="card" indicator-position="none" :autoplay="false">
      <el-carousel-item v-for="img in roomsStore.roomDetails.imgs" :key="img">
      ...
      <div class="details">
        ...
        <section>
          ...
          <div class="owner-details flex">
            ...
            <!-- * Info -->
            <div class="ml-4 py-2">
              <p class="mb-2 font-extrabold text-base text-gray-dark">
